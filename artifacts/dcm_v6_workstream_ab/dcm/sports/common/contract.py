    ...
    SportPluginContract(
        ...
        bindings=(
            ...
            _b(
                "ParticipationModel",
                PARTIAL,
                "dcm.model.basketball_opportunity:OpportunityModel",
                "Minutes/participation is currently bundled into opportunity fitting; a separate validated ParticipationModel is required.",
            ),
            ...
            _b(
                ...
                "Current FeatureStore omits several universal feature families and remains player/team shaped internally.",
            ),
    ...
    SportPluginContract(
        ...
        bindings=(
            ...
            _b(
                "ParticipationModel",
                PARTIAL,
                "dcm.model.gridiron_models:GridironOpportunityModel",
                "Snaps/routes/dropbacks are modeled, but participation is not yet exposed as its own plugin interface.",
            ),
