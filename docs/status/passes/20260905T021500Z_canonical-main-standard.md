...
based on remote v2 head `ebf636e947647010a91bcd973b314465f0b236b1` and targets
`main` through a normal PR and required checks.
...
the remote 11,113-row sanitized fixture, so the complete unfiltered suite and
remote CI remain the authoritative final gate. LR is `LR000000`, predictive
claim is `NONE`, and no production card was issued from fixture evidence.
