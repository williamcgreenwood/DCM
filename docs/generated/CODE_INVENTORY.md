Warning: truncated output (original token count: 38329)
Total output lines: 3202
...
- `function` **_p** L74
- `function` **generate_event_contexts** L81 — Create deterministic latent event states sh…8329 tokens truncated…on` **build_universal_packets** L132
