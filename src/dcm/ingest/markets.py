...
_LEAGUE = {
    ...
    "kbo": ("KBO", "baseball"),
    "npb": ("NPB", "baseball"),
    "ncaa baseball": ("NCAA_BASEBALL", "baseball"),
    "nhl": ("NHL", "hockey"),
    "ahl": ("AHL", "hockey"),
    "khl": ("KHL", "hockey"),
    "ufc": ("UFC", "combat"),
    "mma": ("UFC", "combat"),
    "pfl": ("PFL", "combat"),
    "one championship": ("ONE", "combat"),
    "boxing": ("BOXING", "combat"),
    "pga": ("PGA", "golf"),
    "lpga": ("LPGA", "golf"),
    "liv": ("LIV", "golf"),
    "dp world tour": ("DPWT", "golf"),
    "atp": ("ATP", "racket"),
    "wta": ("WTA", "racket"),
    "itf": ("ITF", "racket"),
    "epl": ("EPL", "soccer"),
    "mls": ("MLS", "soccer"),
    "uefa champions league": ("UCL", "soccer"),
    "ucl": ("UCL", "soccer"),
    "la liga": ("LALIGA", "soccer"),
    "serie a": ("SERIE_A", "soccer"),
    "bundesliga": ("BUNDESLIGA", "soccer"),
    "ligue 1": ("LIGUE_1", "soccer"),
    ...
    "indycar": ("INDYCAR", "motorsport"),
    "afl": ("AFL", "australian_rules"),
    "pll": ("PLL", "lacrosse"),
    "nll": ("NLL", "lacrosse"),
    ...
    "beach volleyball": ("BEACH_VOLLEYBALL", "volleyball"),
    "cs2": ("CS2", "esports"),
    "otd": ("OTD", "unknown"),
}
...
_SPORT_FAMILY = {
    ...
    "australian football": "australian_rules",
