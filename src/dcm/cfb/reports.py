...
def cfb_top100_row(p: dict[str, Any], *, rank: int) -> dict[str, Any]:
    ...
    return {
        ...
        "market": r.get("market"),
        "market_definition": r.get("marketDefinition") or r.get("marketDefinitionId"),
        "line": r.get("line"),
        "offered_sides": _offered_sides(r),
        "preferred_direction": p.get("selectedSide") or r.get("side"),
        "source_format": r.get("sourceFormat"),
        "source_book": r.get("sourceBook"),
        "target_book": r.get("targetBook"),
        "target_book_offer_present": r.get("targetBookOfferPresent"),
        "target_book_odds": r.get("targetBookOdds"),
        "target_book_decimal_odds": r.get("targetBookDecimalOdds"),
        "side_conflict": r.get("sideConflict"),
        "outlier_orf": r.get("outlierOrf"),
        "outlier_orf_score": r.get("outlierOrfScore"),
        "outlier_hit_rates": r.get("outlierHitRates") if isinstance(r.get("outlierHitRates"), dict) else {},
        ...
        "preselection": p.get("preselection"),
        "preselection_policy": p.get("preselectionPolicy"),
        "outlier_preselection_hold": bool(p.get("outlierPreselectionHold")),
